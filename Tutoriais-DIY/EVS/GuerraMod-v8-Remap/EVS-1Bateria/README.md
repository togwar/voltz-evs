# EM CONSUTRUÇÃO!!! VOLTE MAIS TERDE!!! AINDA ESTAMOS EFETUANDO ALGUNS AJUSTES NAS CONFIGURAÇÕES!

# GuerraMod v8 – Projeto Voltz EVS (2026)

**Versão:** 8.0  
**Ano:** 2026  
**Modelo:** EVS com **UMA** Bateria (apenas)
...
- Limites de corrente DC por possuir apenas uma bateria.
...
1. Firmware Base ideal:
	- **A1705_V10000_EVS_70_YM_T8.dat**, powered by APT [saiba mais](https://github.com/togwar/voltz-evs/tree/main/Firmware/APT/evs#%EF%B8%8F-a1705_v10000_evs_70_ym_t8dat---11dez2025)  
2. Motor **in-wheel IPMSM** (sem redução mecânica)  
3. **Corrente DC** como principal fator de stress **e limitante** do sistema  
4. Rotação física máxima ≈ **1100 rpm** (≈ **130 km/h**)  
5. Bateria Li-ion **20S** (1 packs)  
...
**Concluíndo, não há como fazer sua Voltz EVS virar uma 1000cc, tão pouco uma 300cc, sem trocar/modificar equipamentos.**  *OBS: Adquirir uma bateria extra para a EVS transforma ela da "água para o vinho".*
...
- Alterar o valor em **Vdc of idc limit[V]** de 65 para **68**.✅  
...
- Alterar o valor em **Idc min percent[%]** de 20 para **35**.✅  
...
- Alterar o valor em **Li-ion capacity[Ah]** de 0 para **33**.✅💾  
...
- Alterar o valor em **Mode 1 idc[A]** de 58 para **45**.✅  
- Alterar o valor em **Mode 2 idc[A]** de 80 para **60**.✅  
- Alterar o valor em **Mode 3 idc[A]** de 100 para **70**.✅  
- Alterar o valor em **Mode 4 idc[A]** de 80 para **70**.✅  
...
- CURRENT ROT / **Max slip reg Q** = -200✅💾  
...
Em **CURRENT ROT**:
- Alterar o valor em **Max reg Q** de 0 para **-1800**.✅💾  
	> Regen ativo progressivo; força suficiente sem stress térmico.

Em **GTR SETTINGS** para **Cidade/Rodovia**:
- Alterar o valor em **GTR iqref 0[A]** de 0 para **-15**.✅💾 
